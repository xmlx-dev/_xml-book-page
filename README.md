[![GitHub Release](https://img.shields.io/github/v/release/xmlx-dev/xml-book?display_name=tag&logo=github)](https://github.com/xmlx-dev/xml-book/releases/latest)  
[![Read Book][book-badge]](https://book.xmlx.dev)
[![Read Docs](https://img.shields.io/badge/read-docs-blue.svg?logo=gitbook)](https://book.xmlx.dev/docs)  
[![Book Licence](https://img.shields.io/badge/book%20licence-CC%20BY--NC--SA%204.0-lightgrey)](LICENCE)
...
[![Cite BibTeX](https://img.shields.io/badge/cite-bibtex-yellow.svg)](https://book.xmlx.dev/docs/#citing-the-book)
...
The book can be accessed at [book.xmlx.dev][book]
and the documentation at [book.xmlx.dev/docs][docs].

General information about our organisation can be found at [xmlx.dev][org].
Our resources are hosted on GitHub under the [xmlx-dev][gh_org] organisation.
...
[master]: https://github.com/xmlx-dev/xml-book/tree/master
[gh_pages]: https://github.com/xmlx-dev/xml-book/tree/gh-pages
[gh_org]: https://github.com/xmlx-dev
[org]: https://xmlx.dev/
[book]: https://book.xmlx.dev/
[docs]: https://book.xmlx.dev/docs
